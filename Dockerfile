...
RUN pip install -q opencv-python imageio imageio-ffmpeg ffmpeg-python av runpod && \
    git clone -b v1.2 https://github.com/camenduru/Open-Sora-Plan /content/Open-Sora-Plan && cd /content/Open-Sora-Plan && pip install .
...
RUN aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/google/mt5-xxl/raw/main/config.json -d /content/mt5-xxl -o config.json && \
    ...
    aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/google/mt5-xxl/resolve/main/tf_model.h5 -d /content/mt5-xxl -o tf_model.h5 && \
